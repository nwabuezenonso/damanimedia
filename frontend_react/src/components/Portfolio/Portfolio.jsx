...
const Stories = () => {
  ...
  useEffect(() => {
    ...
    client.fetch(query).then((data) => setStoryHeader(data));      // get the data and set it
  ...
  return (
    <>
    <div className="app__gallery portfolio_bg_img flex__center">
      <div className="app__gallery-content">
      </div>
      <div className="app__gallery-images">
        <div className="app__gallery-images_container" ref={scrollRef}>
          {storyHeader.map((story, index) => (
        ...
        {filterStories.map((filter, index) => (
          <div className="app__work-item app__flex" key={index}>
            <div className="app__work-img app__flex">
              <img src={urlFor(filter.imgUrl)} alt={filter.name} onClick={() => setIsOpen(true)}/>
